...
HD_PWD='D:/MyProjects/Projects/SG/Nov5/SG/hw/hw.runs/system_AXI_BayerToRGB_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_AXI_BayerToRGB_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_AXI_BayerToRGB_0_0.tcl
