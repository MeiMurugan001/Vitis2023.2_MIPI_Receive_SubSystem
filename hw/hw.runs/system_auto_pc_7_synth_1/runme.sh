...
HD_PWD='D:/MyProjects/Projects/SG/Nov5/SG/hw/hw.runs/system_auto_pc_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_auto_pc_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_auto_pc_7.tcl
