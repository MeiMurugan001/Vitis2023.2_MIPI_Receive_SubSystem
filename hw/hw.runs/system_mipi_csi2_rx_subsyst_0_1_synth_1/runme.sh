...
HD_PWD='D:/MyProjects/Projects/SG/Nov5/SG/hw/hw.runs/system_mipi_csi2_rx_subsyst_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_mipi_csi2_rx_subsyst_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_mipi_csi2_rx_subsyst_0_1.tcl
