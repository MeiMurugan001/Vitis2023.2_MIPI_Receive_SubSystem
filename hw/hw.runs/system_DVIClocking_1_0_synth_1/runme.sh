...
HD_PWD='D:/MyProjects/Projects/SG/Nov5/SG/hw/hw.runs/system_DVIClocking_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_DVIClocking_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_DVIClocking_1_0.tcl
