...
# IP: bd/system/ip/system_AXI_BayerToRGB_0_0/system_AXI_BayerToRGB_0_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==system_AXI_BayerToRGB_0_0 || ORIG_REF_NAME==system_AXI_BayerToRGB_0_0} -quiet] -quiet

# IP: bd/system/ip/system_AXI_GammaCorrection_1_0/system_AXI_GammaCorrection_1_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==system_AXI_GammaCorrection_1_0 || ORIG_REF_NAME==system_AXI_GammaCorrection_1_0} -quiet] -quiet

# IP: bd/system/ip/system_DVIClocking_1_0/system_DVIClocking_1_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==system_DVIClocking_1_0 || ORIG_REF_NAME==system_DVIClocking_1_0} -quiet] -quiet
...
# XDC: d:/MyProjects/Projects/SG/Nov5/SG/hw/hw.gen/sources_1/bd/system/system_ooc.xdc
